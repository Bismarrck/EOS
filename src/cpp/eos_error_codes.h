...
constexpr int EOS_ERROR_COMPLICATED_EOS_INIT_FAILED = 28;
constexpr int EOS_ERROR_COMPLICATED_EOS_EMPTY_PARAMS = 29;
constexpr int EOS_ERROR_PACK_FAILED = 30;
constexpr int EOS_ERROR_POLY_EOS_INIT_FAILED = 31;
constexpr int EOS_ERROR_POLY_EOS_EMPTY_PARAMS = 32;
